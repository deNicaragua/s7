...
public class JwtCsrfFilter extends OncePerRequestFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain filter,
        ...
        //User user = request.;
        String access_token = TokenValidator.generateToken(new User(request.getParameter("name"),
                request.getParameter("login"),
                request.getParameter("password")));
        String refresh_token = TokenValidator.generateToken(new User(request.getParameter("name"),
                request.getParameter("login"),
                request.getParameter("password")));
        System.out.println(request.toString());
        response.setHeader("access", access_token);
        response.setHeader("access", refresh_token);
    }*/
